  ...
  return (
    <div className="min-h-dvh bg-brand-dark flex flex-col items-center justify-center px-6">
      ...
      <div className="w-full max-w-sm">
        {/* logo.png is dark blue; invert to white so it's visible on the dark brand background */}
        <img src="/logo.png" alt="WOW Corporation" className="h-20 w-auto mx-auto mb-4 filter invert brightness-0" />
